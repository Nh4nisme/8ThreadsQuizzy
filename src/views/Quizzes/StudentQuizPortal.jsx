                  ...
                  >
                    <div className="mb-10">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className={`rounded-lg px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] border ${
                      ...
                      {question.choices.map((choice, i) => {
                        ...
                        return (
                          <motion.button
                            ...
                            className={`group relative flex flex-col items-start rounded-3xl border-2 p-6 text-left transition-all duration-300 ${
                              isSelected
                          ...
                          >
                            <div className="flex w-full items-center justify-between mb-4">
                               <span className={`flex items-center justify-center w-8 h-8 rounded-xl text-xs font-black border-2 transition-colors ${
                                 isSelected ? "bg-accent border-accent text-white" : "bg-white/5 border-white/10 text-text-muted group-hover:border-white/30"
                               }`}>
                                 {choice.label}
                               </span>
                               {isSelected && (
                ...
                {quiz.questions.map((q, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative group h-11 w-11 rounded-xl flex items-center justify-center text-xs font-black transition-all ${
                        isCurrent 
                ...
                {filteredItems.map((item) => {
                  ...
                  return (
                    <StaggerItem key={item._id || item.slug}>
                      <motion.article
                        whileHover={{ y: -8 }}
                        className={`group relative overflow-hidden rounded-[32px] border border-white/5 bg-[#111115]/60 p-8 transition-all duration-500 backdrop-blur-md ${
                          isDisabled ? "opacity-60 cursor-not-allowed" : "hover:border-white/20 hover:bg-[#1a1a1f]/80"
                        }`}
                      >
                          ...
                          <div className="mt-auto pt-6 border-t border-white/5">
                             <div className="flex items-center justify-between">
                                ...
                                <button
                                  ...
                                  disabled={isDisabled}
                                  className={`rounded-2xl px-6 py-3 text-xs font-black transition-all ${
                                    isDisabled 
