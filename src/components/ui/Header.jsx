    ...
    return (
        ...
        8ThreadsQuizzy
            ...
            <nav className="flex gap-6 ml-8">
                <span className="text-sm text-white hover:text-purple-400 cursor-pointer">Quiz</span>
                <span className="text-sm text-white hover:text-purple-400 cursor-pointer">Weekly Quiz</span>
                <span className="text-sm text-white hover:text-purple-400 cursor-pointer">Rewards</span>
                <span className="text-sm text-white hover:text-purple-400 cursor-pointer">About</span>
            </nav>
            {/* Buttons */}
