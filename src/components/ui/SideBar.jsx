...
const SideBar = () => {
  ...
  return (
    <aside className="bg-bg-card h-screen w-[280px] p-6 flex flex-col border-r border-white/5 sticky top-0 z-40">
      ...
      <div className="flex-1 space-y-8 overflow-y-auto custom-scrollbar pr-2">
        <section>
          <nav className="space-y-1">
            {mainMenu.map((item) => (
              <MenuItem key={item.path} item={item} active={isActive(item.path)} />
            ))}
          </nav>
        </section>
